        ...
        switch (v.getId()) {
            ...
            case R.id.btn_sumbit:
                if (et_person_name.getText().toString().equals("")) {
                    Toast.makeText(SearchMemberActivity.this, "请输入员工姓名", Toast
                            .LENGTH_SHORT).show();
                } else if (et_person_number.getText().toString().equals("")) {
                    Toast.makeText(SearchMemberActivity.this, "请输入登录账号", Toast
                            .LENGTH_SHORT).show();
                } else if (et_phone.getText().toString().equals("")) {
                    Toast.makeText(SearchMemberActivity.this, "请输入手机号码", Toast
                            .LENGTH_SHORT).show();
                } else if (userType.equals("")) {
                    Toast.makeText(SearchMemberActivity.this, "请选择账号类型", Toast
                            .LENGTH_SHORT).show();
                } else {
            ...
            case R.id.select_persontype:
                ...
                AlertDialog.Builder alertBuilder = new AlertDialog.Builder(SearchMemberActivity.this);
